...
(define keyLst (list
                ...
                (cons '(mod4 Return) "st") ;Moved to dwm config.
                ;; (cons '(mod4 shift Return) "kitty")
                ;; ––– •char number• –––
                ;; (cons '(SEQ 1) "BIND")
                ...
                ;; (cons '(mod4 r) "st -e ranger")
                ;; (cons '(mod4 shift r) "kitty -e ranger")
                ...
                ;; (cons '(mod4 b) "xlinks2")
                ;; (cons '(mod4 shift b) "firefox")
                ;; (cons '(mod4 n) "nautilus")
