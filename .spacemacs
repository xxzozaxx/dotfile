...
(defun dotspacemacs/layers ()
  (setq-default
   ...
   '(
     ...
     ;;  ---- Application -----
     org  dired gnus eww ;jabber ;vinegar ;pdf-tools
     (mu4e :variables
