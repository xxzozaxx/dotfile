...
(defun dotspacemacs/layers ()
  (setq-default
   ...
   '(;; ---- Languages -----
     ...
     ;;   ---- Application -----
     dired pdf-tools erc emms org ;eww ;gnus pandoc ;jabber ;vinegar
     (mu4e :variables
...
values."
  (setq-default
   ...
   dotspacemacs-themes '(
                         gruvbox-light-medium spacemacs-light nyx
                         )
