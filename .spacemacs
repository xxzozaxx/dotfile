...
values."
  (setq-default
   ...
   dotspacemacs-default-font '("SF Mono Medium"
                               :size 12
                               :weight normal
                               :width normal
                               :powerline-scale 1.4)
