...
(defun dotspacemacs/layers ()
  (setq-default
   ...
   '(;; ---- Languages -----
     ...
     rust go c-c++ scheme sml ocaml coq ; racket ruby javascript java d  common-lisp
